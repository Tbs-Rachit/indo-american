$(document).ready(function() {
	...
	jQuery("#aj_company").change(function() {
		...
		jQuery.get(base_url + "/get_locations/" + jQuery(this).val(), function(
			data,
			status
		) {
	...
	$(".edit-modal-data").on("show.bs.modal", function(event) {
		...
		$.ajax({
			...
			type: "GET",
			data:
				"jd=1&is_ajax=1&mode=modal&data=transfer&transfer_id=" + transfer_id,
	...
	$(".view-modal-data").on("show.bs.modal", function(event) {
		...
		$.ajax({
			...
			type: "GET",
			data:
				"jd=1&is_ajax=1&mode=modal&data=view_transfer&transfer_id=" +
				transfer_id,
			success: function(response) {
				if (response) {
	...
	jQuery("#xin-form").validate({
		...
		messages: {
			...
			transfer_department: "Please select transfer department",
			transfer_location: "Please select transfer location",
		},
