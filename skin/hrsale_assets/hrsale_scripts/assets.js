$(document).ready(function() {
    ...
    $("#ihr_report").submit(function(e) {
        ...
        var xin_table2 = $('#xin_table').dataTable({
            "bDestroy": true,
            "ajax": {
                url: base_url + "/assets_list/?ihr=true&category_id=" + $('#filter_category').val(),
                type: 'GET'
            },
            "fnDrawCallback": function(settings) {
                $('[data-toggle="tooltip"]').tooltip();
    ...
    $("#xin-form").validate({
        ...
        messages: {
            ...
            company_asset_code: { required: "Please select employee" },
            asset_image: { required: "Please select asset image" },
        },
        submitHandler: function(form) {
            add_asset_formSubmit(form);
        }
    });
    // $("#xin-form").submit(function (e) {
    function add_asset_formSubmit(form) {
