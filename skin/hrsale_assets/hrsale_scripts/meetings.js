$(document).ready(function () {
	...
	$("#xin-form").validate({
		rules: {
			...
			meeting_time: { required: true },
		},
		// Specify validation error messages
		messages: {
			company_id: { required: "Please select company" },
			employee_id: { required: "Please select employee" },
			meeting_title: { required: "Please enter title" },
			meeting_date: { required: "Please enter date" },
			meeting_time: { required: "Please enter time" },
		},
		submitHandler: function (form) {
			add_meeting_formSubmit(form);
		}
	});

	// $("#xin-form").submit(function (e) {
	function add_meeting_formSubmit(form) {
		// e.preventDefault();
