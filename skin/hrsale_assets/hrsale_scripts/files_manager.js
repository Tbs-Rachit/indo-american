$(document).ready(function () {
	...
	$("#xin-form").validate({
		rules: {
			...
			xin_file: {
				required: true,
				extension: "gif|png|pdf|txt|doc|docx"
			},
		},
		...
		messages: {
			...
			xin_file: {
				...
				extension: "Please enter a value with a valid extension gif,png,pdf,txt,doc,docx."
			},
		},
		submitHandler: function (form) {
			file_manager_form(form);
		}
	});

	// $("#xin-form").submit(function (e) {
	function file_manager_form(form) {
