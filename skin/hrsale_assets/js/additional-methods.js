...
(function(factory) {
    ...
    $.validator.addMethod(
        ...
        $.validator.format(
            "Please enter a value with a valid extension png | jpeg | jpg | gif."
        )
    );
    ...
    $.validator.addMethod(
        ...
        "Please Enter only space & alphabets"
    );
    ...
    $.validator.addMethod(
        ...
        "Please Enter Letters, space and dot"
    );
    $.validator.addMethod(
        "letterswithdot",
        function(value, element) {
    ...
    $.validator.addMethod(
        "passwordvalidation",
        function(value, element) {
            var alphaReg = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#\$%\^&\*])(?=.*\d).{6,}$/;

            return this.optional(element) || alphaReg.test(value);
        },
        "Enter a combination of at least 6 characters or longer, uppercase letter, lowercase letter, special character and number."
    );
    return $;
});