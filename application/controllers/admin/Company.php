...
class Company extends MY_Controller {
	...
	public function add_company() {
		...
		} else if ($this->Company_model->check_comapny_username($this->input->post('username')) > 0) {
			$Return['error'] = $this->lang->line('xin_company_code_already_exist');
		}
	...
	public function update() {
		...
		$Return = array('result'=>'', 'error'=>'', 'csrf_hash'=>'');
		$Return['csrf_hash'] = $this->security->get_csrf_hash();
		$company_code  = $this->Company_model->check_comapny_username_edit($id, $this->input->post('username'));
