          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class='form-group'>
                ...
                <?php if($logo!='' && $logo!='no file') {?>
                <img src="<?php echo base_url().'uploads/logo/'.$logo;?>" width="250px" style="margin-left:30px;" id="u_file_1">
                <?php } else {?>
            ...
            <div class="col-md-6">
              <div class='form-group'>
                ...
                <?php } else {?>
                <img src="<?php echo base_url().'uploads/logo/no_logo.png';?>" width="32px" style="margin-left:30px;" id="favicon1">
                <?php } ?>
                <br>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class='form-group'>
                ...
                <img src="<?php echo base_url().'uploads/logo/signin/'.$sign_in_logo;?>" width="250px" style="margin-left:30px;" id="u_file3">
                <?php } else {?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class='form-group'>
                ...
                <img src="<?php echo base_url().'uploads/logo/job/'.$job_logo;?>" width="250px" style="margin-left:30px;" id="u_file4">
                <?php } else {?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class='form-group'>
                ...
                <img src="<?php echo base_url().'uploads/logo/payroll/'.$payroll_logo;?>" width="250px" style="margin-left:30px;" id="u_file5">
                <?php } else {?>
