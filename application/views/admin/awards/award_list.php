            ...
            <div class="row">
              <div class="col-md-6 selectdiv">
                ...
                <div class="form-group" id="employee_ajax">
                  ...
                  <select name="employee_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_an_employee');?>" required>
                    <option value=""></option>
                  </select>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="award_type_id" id="select2-demo-7" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_award_type');?>" required>
                        <option value=""></option>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_award_date');?>" readonly name="award_date" type="text" value="" required>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_description');?>" name="description" cols="30" rows="6" id="description" required></textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
