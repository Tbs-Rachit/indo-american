...
?>
  ...
  <div class="modal-body">
    ...
    <div class="row">
      <div class="col-md-3">
        <label for="email"><?php echo $this->lang->line('xin_company_code'); ?></label>
        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_code'); ?>" name="username" type="text" value="<?php echo $username; ?>">
      </div>
      <div class="col-md-6">
