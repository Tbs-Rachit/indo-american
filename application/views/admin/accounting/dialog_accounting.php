    ...
    $(document).ready(function() {
      ...
      $("#bankcash_update").validate({
        ...
        messages: {
          ...
          account_balance: {
            required: "Please enter inital balance"
          },
          account_number: {
        ...
        submitHandler: function(form) {
          bankcash_update_formSubmit(form);
        }
      });

      // $("#bankcash_update").submit(function(e) {
      function bankcash_update_formSubmit(form) {
        // e.preventDefault();
        var obj = $(form),
  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="award_type"><?php echo $this->lang->line('xin_acc_account'); ?></label>
          <select name="bank_cash_id" id="bank_cash_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_choose_account_type'); ?>">
            <option value=""></option>
            <?php foreach ($all_bank_cash as $bank_cash) { ?>
              <option value="<?php echo $bank_cash->bankcash_id; ?>" <?php if ($account_type_id == $bank_cash->bankcash_id) : ?> selected="selected" <?php endif; ?>><?php echo $bank_cash->account_name; ?></option>
            <?php } ?>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="employee"><?php echo $this->lang->line('xin_acc_category'); ?></label>
              <select name="category_id" id="category_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_choose_category'); ?>">
                <option value=""></option>
                <?php foreach ($all_income_categories_list as $income_category) { ?>
                  <option value="<?php echo $income_category->category_id; ?>" <?php if ($categoryid == $income_category->category_id) : ?> selected="selected" <?php endif; ?>> <?php echo $income_category->name; ?></option>
                <?php } ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="employee"><?php echo $this->lang->line('xin_acc_payer'); ?></label>
              <select name="payer_id" id="payer_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_payer'); ?>">
                <option value=""></option>
                <?php foreach ($all_payers as $payer) { ?>
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          <label for="payment_method"><?php echo $this->lang->line('xin_payment_method'); ?></label>
          <select name="payment_method" id="payment_method" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_payment_method'); ?>">
            <option value=""></option>
            <?php foreach ($get_all_payment_method as $payment_method) { ?>
              <option value="<?php echo $payment_method->payment_method_id; ?>" <?php if ($payment_method_id == $payment_method->payment_method_id) : ?> selected="selected" <?php endif; ?>> <?php echo $payment_method->method_name; ?></option>
            <?php } ?>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#deposit_update").validate({
        ...
        submitHandler: function(form) {
          update_deposit_formSubmit(form);
        }

      });
      // $("#deposit_update").submit(function(e) {
      function update_deposit_formSubmit(form) {
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#expense_update").validate({
        ...
        submitHandler: function(form) {
          update_expense_formSubmit(form);
        }

      });

      // $("#expense_update").submit(function(e) {
      function update_expense_formSubmit(form) {
        var fd = new FormData(form);
        var obj = $(form),
          action = obj.attr('name');
        fd.append("is_ajax", 1);
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#update_payer").validate({
        ...
        submitHandler: function(form) {
          update_payer_formSubmit(form);
        }
      });

      // $("#update_payer").submit(function(e) {
      function update_payer_formSubmit(form) {
        // e.preventDefault();
        var obj = $(form),
          action = obj.attr('name');
        $('.save').prop('disabled', true);
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $("#update_payee").validate({
        ...
        submitHandler: function(form) {
          update_payee_formSubmit(form);
        }
      });

      // $("#update_payee").submit(function(e) {
      function update_payee_formSubmit(form) {
        // e.preventDefault();
        var obj = $(form),
          action = obj.attr('name');
        $('.save').prop('disabled', true);
