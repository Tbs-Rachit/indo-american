            ...
            <div class="row">
              <div class="col-md-7 selectdiv">
                <div class="form-group">
                  ...
                  <select name="bank_cash_id" id="bank_cash_id" class="from-account form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_choose_account_type');?>">
                    <option value=""></option>
            ...
            <div class="row">
              <div class="col-md-3 selectdiv">
                <div class="form-group">
                  ...
                  <select name="payment_method" id="payment_method" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_payment_method');?>">
                    <option value=""></option>
