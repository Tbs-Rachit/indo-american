            ...
            <div class="row">
              <div class="col-md-3 selectdiv">
                <div class="form-group">
                  ...
                  <select name="from_bank_cash_id" id="from_bank_cash_id" class="from-account form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_choose_account_type');?>">
                    <option value=""></option>
              ...
              <div class="col-md-3 selectdiv">
                <div class="form-group">
                  ...
                  <select name="to_bank_cash_id" id="to_bank_cash_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_choose_account_type');?>">
                    <option value=""></option>
                    <?php foreach($all_bank_cash as $bank_cash) {?>
