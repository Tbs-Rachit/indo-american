...
?>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control d_date" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly="true" name="start_date" id="d_start_date" type="text" value="<?php echo $start_date; ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="end_date"><?php echo $this->lang->line('xin_end_date'); ?></label>
              <input class="form-control d_date" placeholder="<?php echo $this->lang->line('xin_end_date'); ?>" readonly="true" name="end_date" id="d_end_date" type="text" value="<?php echo $end_date; ?>">
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      var date = $("#d_start_date").val();
      $("#d_end_date").datepicker("option", "minDate", date)
      jQuery('#d_start_date').on('change', function() {
        var date = $(this).val();
        $("#d_end_date").datepicker("option", "minDate", date)
      });
      ...
      $("#edit_goal").validate({
        ...
        messages: {
          ...
          tracking_type: {
            required: "Please select tracking type"
          },
          subject: {
