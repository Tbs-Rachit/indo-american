  ...
  <div class="modal-body selectdiv">
    <div class="row">
      <div class="col-md-6">
        ...
        <?php } else { ?>
          <?php $result = $this->Department_model->ajax_company_employee_info($company_id); ?>
          <input type="hidden" name="company_id" value="<?php foreach ($get_all_companies as $company) { ?><?php if ($company->company_id == $company_id) : echo $company->company_id;
                                                                                                            endif; ?><?php } ?>">
          <input type="hidden" name="employee_id" value="<?php foreach ($result as $employee) { ?><?php if ($employee->user_id == $employee_id) : echo $employee->user_id;
                                                                                                  endif; ?><?php } ?>">
        <?php } ?>
        <div class="row">
          <div class="col-md-6">
    ...
    $(document).ready(function() {
      ...
      $("#edit_travel").validate({
        ...
        messages: {
          ...
          visit_purpose: "Please select visit purpose",
          visit_place: "Please select visit place",
          description: "Please insert description",
          expected_budget: {
            required: "Please insert expected budget",
            number: "Please insert only number"
          },
          actual_budget: {
            required: "Please insert actual budget",
            number: "Please insert only number"
          },
          travel_mode: "Please select travel mode",
          arrangement_type: "Please select arrengment type",
