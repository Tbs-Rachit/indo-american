            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group" id="employee_ajax">
                  ...
                  <select multiple="multiple" disabled="disabled" name="employee_id[]" id="employee_id" class="form-control employee-data" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_an_employee');?>" required>
                  </select>
                </div>
                <?php } else {?>
