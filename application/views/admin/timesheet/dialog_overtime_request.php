		...
		$(document).ready(function() {
			...
			$("#add_attendance").validate({
				...
				submitHandler: function(form) {
					add_attendanceformSubmit(form);
				}
			});

			// $("#add_attendance").submit(function(e){
			function add_attendanceformSubmit(form) {
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#edit_attendance").validate({
				...
				submitHandler: function(form) {
					edit_attendanceformSubmit(form);
				}
			});

			// $("#edit_attendance").submit(function(e) {
			function edit_attendanceformSubmit(form) {
