...
?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="display: table-cell;">
              <ol><?php foreach ($all_employees as $employee) { ?>
  ...
  ?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control edate" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly="true" name="start_date" id="start_date_modal" type="text" value="<?php echo $start_date; ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="end_date"><?php echo $this->lang->line('xin_end_date'); ?></label>
                <input class="form-control edate" placeholder="<?php echo $this->lang->line('xin_end_date'); ?>" readonly="true" name="end_date" id="end_date_modal" type="text" value="<?php echo $end_date; ?>">
              </div>
            </div>
          </div>
          <div class="row">
    ...
    <script type="text/javascript">
      var site_url = '<?php //echo site_url().$_GET['mname']; ?>/';
    </script>
    <script type="text/javascript">
