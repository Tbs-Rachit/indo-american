            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-1"><label for="xin_get">&nbsp;</label><br /><button name="hrsale_form" type="submit" class="btn btn-primary"><i class="fa fa fa-check-square-o"></i> <?php echo $this->lang->line('xin_get'); ?></button>
                  </div>
                </div>
                ...
                <div class="col-md-6 selectdiv">
                      ...
                      <select class="form-control" id="leave_type" name="leave_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_leave_type'); ?>">
                        ...
                        <?php foreach ($all_leave_types as $type) {
                          ...
                          if (in_array($type->leave_type_id, $leave_categories_ids)) {
                            ...
                            if ($count_l == $type->days_per_year) { ?>
                              <option value="<?php echo $type->leave_type_id; ?>" disabled> <?php echo $type->type_name; ?> (<?= $count_l; ?> / <?= $type->days_per_year ?> ) </option>
                            <?php } else { ?>
                              <option value="<?php echo $type->leave_type_id; ?>"> <?php echo $type->type_name; ?> (<?= $count_l; ?> / <?= $type->days_per_year ?> ) </option>
                        <?php }
                          }
                        }  ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="leave_take" id="leave_take" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_hr_leave_take'); ?>">
                      <option value=""></option>
                      <option value="1"><?php echo $this->lang->line('xin_hr_leave_first_half_day'); ?></option>
                      <option value="2"><?php echo $this->lang->line('xin_hr_leave_second_half_day'); ?></option>
                      <option value="3"><?php echo $this->lang->line('xin_hr_leave_full_day'); ?></option>
                    </select>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly name="start_date" id="start_date" type="text" value="">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="end_date"><?php echo $this->lang->line('xin_end_date'); ?></label>
                        <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_end_date'); ?>" readonly name="end_date" id="end_date" type="text" value="">
                      </div>
                    </div>
                  </div>
                  <?php $role_resources_ids = $this->Xin_model->user_role_resource();
                ...
                <div class="col-md-6">
                  ...
                  <!-- <div class="form-group">
                    <label>
                      ...
                      <?php //echo $this->lang->line('xin_hr_leave_half_day'); 
                      ?></span> </label>
                  </div> -->
                </div>
              </div>
