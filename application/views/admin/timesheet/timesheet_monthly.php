...
if($user_info[0]->user_role_id==1 || !in_array('555', $role_resources_ids)){
	...
	if(!isset($month_year)){
		...
		if($this->input->post('employee_id')==0){
			// $xin_employees = $this->Timesheet_model->get_xin_employees_company($employee_id, $company_id);
			$xin_employees = $this->Department_model->ajax_company_employee_info($company_id);
		} else {
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <?php if($user_info[0]->user_role_id==1 || !in_array('555', $role_resources_ids)){?>
          <div class="col-md-3">
            <div class="form-group">
