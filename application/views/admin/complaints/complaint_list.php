                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group" id="complaint_employee_ajax">
                      ...
                      <select multiple class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_complaint_employees');?>" name="complaint_against[]" id="complaint_against">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
