              ...
              <div class="row">
                <div class="col-md-6 selectdiv">
                  ...
                  <div class="form-group" id="employee_ajax">
                    ...
                    <select class="form-control" name="employee_id" id="select2-demo-6"  data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_an_employee'); ?>">
                      <option value=""></option>
                  ...
                  <div class="row">
                    <div class="col-md-6 selectdiv">
                      <div class="form-group" id="department_ajax">
                        ...
                        <select class="select2" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_department'); ?>" id="select2-demo-7" name="transfer_department">
                          <option value=""></option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group" id="location_ajax">
                        ...
                        <select class="select2" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_transfer_select_location'); ?>" id="transfer_location"name="transfer_location">
                          <option value=""></option>
                        </select>
                      </div>
                    </div>
