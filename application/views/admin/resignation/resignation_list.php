              ...
              <div class="row">
                <div class="col-md-6 selectdiv">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="start_date"><?php echo $this->lang->line('xin_notice_start_date'); ?></label>
                        <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_notice_start_date'); ?>" readonly name="start_date" id="start_date" type="text">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="end_date"><?php echo $this->lang->line('xin_notice_end_date'); ?></label>
                        <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_notice_end_date'); ?>" readonly name="end_date" id="end_date" type="text">
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_notice_start_date'); ?></th>
            <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_notice_end_date'); ?></th>
