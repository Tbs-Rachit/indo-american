    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="notice_date"><?php echo $this->lang->line('xin_notice_start_date'); ?></label>
              <input class="form-control d_date" placeholder="<?php echo $this->lang->line('xin_notice_start_date'); ?>" readonly name="start_date" id="s_date" type="text" value="<?php echo $start_date; ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="notice_date"><?php echo $this->lang->line('xin_notice_end_date'); ?></label>
              <input class="form-control d_date" placeholder="<?php echo $this->lang->line('xin_notice_end_date'); ?>" readonly name="end_date" id="e_date" type="text" value="<?php echo $end_date; ?>">
            </div>
          </div>
        </div>
      </div>
    ...
    $(document).ready(function() {
      ...
      $("#edit_resign").validate({
        ...
        messages: {
          ...
          employee_id: "Please select resigning employee",
          start_date: "Please select notice start date",
          end_date: "Please select notice end date",
          reason: "Please enter your reason",
          resignation_date: "Please select resignation date"
        },
    ...
    <div class="modal-body">
      <table class="footable-details table table-striped table-hover toggle-circle">
        <tbody>
          ...
          <tr>
            <th><?php echo $this->lang->line('xin_notice_start_date'); ?></th>
            <td style="display: table-cell;"><?php echo $this->Xin_model->set_date_format($start_date); ?></td>
          </tr>
          <tr>
            <th><?php echo $this->lang->line('xin_notice_end_date'); ?></th>
