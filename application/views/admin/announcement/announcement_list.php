                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly id="start_date" name="start_date" type="text" value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 selectdiv">
                    <div class="form-group" id="department_ajax">
                      ...
                      <select class="form-control" name="department_id" id="aj_department" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_department'); ?>">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="form-group selectdiv" id="employee_ajax">
                  <label for="employee_id"><?php echo $this->lang->line('dashboard_single_employee'); ?></label>
                  <!-- <input type="hidden" name="employee_id[]" value="0" /> -->
                  <select multiple="multiple" class="form-control" name="employee_id[]" id="employee_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_an_employee'); ?>">
                    <option value=""></option>
                  </select>
                </div>
              </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th width="400"><?php echo $this->lang->line('xin_title'); ?></th>
