    ...
    <div class="box mb-4 <?= $get_animate ?>">
        <div id="accordion">
            <div class="box-header  with-border">
                <h3 class="box-title"><?php echo $this->lang->line('xin_add_new'); ?> <?php echo $this->lang->line('xin_reimbursement'); ?></h3>
            ...
            <div id="add_form" class="collapse add-form <?php echo $get_animate; ?>" data-parent="#accordion" style="">
                <div class="box-body">
                    <?php $attributes = array('name' => 'add_reimbursement', 'id' => 'xin-form', 'autocomplete' => 'off'); ?>
                    <?php $hidden = array('user_id' => $session['user_id']); ?>
                    <?php echo form_open_multipart('admin/reimbursement/add_reimbursement', $attributes, $hidden); ?>
                    <div class="bg-white">
                        <div class="box-block">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_reimbursement_date'); ?>" readonly name="reimbursement_date" type="text">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
...
<div class="box <?php echo $get_animate; ?>">
    <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_list_all'); ?> <?php echo $this->lang->line('left_reimbursement'); ?> </h3>
    </div>
    <div class="box-body">
            ...
            <table class="datatables-demo table table-striped table-bordered" id="xin_table">
                <thead>
                    <tr>
                        ...
                        <th><i class="fa fa-user"></i> <?php echo $this->lang->line('left_company'); ?></th>
                        <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_reimbursement_date'); ?></th>
                        <th><i class="fa fa-calendar"></i> <?php echo $this->lang->line('xin_amount'); ?></th>
                    </tr>
                </thead>
            </table>
        </div>
