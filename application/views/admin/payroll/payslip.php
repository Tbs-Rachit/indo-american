            ...
            <tbody>
              <tr>
                ...
                <!-- <td><strong class="help-split"><?php //echo $this->lang->line('xin_payslip_number'); 
                                                    ?>: </strong><?php //echo $make_payment_id; 
                                                                                                                        ?></td> -->
              ...
              <tr>
                ...
                if (!empty($module_attributes)) {
                  foreach ($module_attributes as $key => $attr) {
                    $attribute_info = $this->Custom_fields_model->get_employee_custom_data($euser_id, $module_attributes[$key]->custom_field_id);
                    if (!is_null($attribute_info)) {
                      $attr_val = $attribute_info->attribute_value;
                      // $dataAttr['lable'] = $module_attributes[$key]->attribute_label;
                      $dataAttr[$module_attributes[$key]->attribute_label] = $attr_val;
                    }
                  }
                  $row = 1;
                ...
                ?>
                    <td><strong class="help-split"><?php echo $key; ?>: </strong><?php echo $val; ?></td>
                    <?php
                    if ($row % 3 === 0) {
                    ?></tr>
              <tr><?php
                    ...
                    <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                      <tbody>
                        ...
                        ?>
                          ...
                          <tr>
                            <td><strong><?php echo  $allowance_name[0]->salary_benefit_name; ?>:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sl_allowances->allowance_amount); ?></span></td>
                          </tr>
                        <?php } ?>
                        <tr>
                    ...
                    <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                      <tbody>
                        ...
                        ?>
                          ...
                          ?>
                          <tr>
                            <td><strong><?= $deduction_name[0]->salary_benefit_name; ?> :</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($single_sd); ?></span></td>
                          </tr>
                        <?php } ?>
                        <tr>
