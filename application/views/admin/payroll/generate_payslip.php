          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <?php if ($user_info[0]->user_role_id == 1 || in_array('314', $role_resources_ids)) { ?>
                ...
                <div class="col-md-3">
                  <div class="from-group" id="location_aj">
                    <label for="loaction"><?= $this->lang->line('left_location'); ?></label>
                    <select id="location_id_aj" name="location_id_aj" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_location'); ?>">
                    <option value="0"><?= $this->lang->line('xin_acc_all'); ?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-3">
