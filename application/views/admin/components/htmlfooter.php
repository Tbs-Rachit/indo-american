...
<script src="<?php echo base_url(); ?>skin/hrsale_assets/js/jquery.validate.min.js"></script>
<script src="<?php echo base_url(); ?>skin/hrsale_assets/js/additional-methods.js"></script>
<!-- <script src="<?php echo base_url(); ?>skin/hrsale_assets/js/jquery-validate.bootstrap-tooltip.js"></script> -->
...
<script src="<?php echo base_url(); ?>skin/hrsale_assets/js/dev.js"></script>
...
<?php if ($this->router->fetch_method() == 'task_details' || $this->router->fetch_method() == 'project_details' || $this->router->fetch_class() == 'project') { ?>
	<script type="text/javascript">
		$(document).ready(function() {
			var progress = '<?php echo isset($progress) ? $progress : '0'; ?>';
