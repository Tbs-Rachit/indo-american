...
<section class="sidebar">
  ...
  <div class="user-panel">
    ...
    <div class="info">
      ...
      <div style="display: none"><a href="<?php echo site_url('admin/profile'); ?>"><i class="fa fa-user"></i></a>
      ...
      <li class="<?php if (!empty($arr_mod['emp_open'])) echo $arr_mod['emp_open']; ?> treeview"> <a href="#"> <i class="fa fa-futbol-o"></i> <span><?php echo $this->lang->line('xin_hr'); ?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          ...
          <?php if (in_array('444', $role_resources_ids)) { ?>
            <li class="sidenav-link <?php if (!empty($arr_mod['reim_active'])) echo $arr_mod['reim_active']; ?>"> <a href="<?php echo site_url('admin/reimbursement'); ?>"> <i class="fa <?php echo $submenuicon; ?>"></i> <?php echo $this->lang->line('left_reimbursement'); ?> </a> </li>
          <?php } ?>
        </ul>
      </li>
    <?php } ?>
