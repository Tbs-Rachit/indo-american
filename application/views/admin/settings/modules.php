    ...
    <div class="card-datatable table-responsive">
      <table class="datatables-demo table table-striped table-hover table-bordered" id="xin_table">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $this->lang->line('xin_employee_biometric');?></td>
                <td><?php echo sprintf($this->lang->line('xin_biometric_details'),$company[0]->company_name);?></td>
                <td><input data-group-cls="btn-group-sm" type="checkbox" class="js-switch switch" id="m-biometric" <?php if($is_active_biometric=='yes'):?> checked="checked" <?php endif;?> value="yes" /></td>
            </tr>						
        </tbody>
      </table>
