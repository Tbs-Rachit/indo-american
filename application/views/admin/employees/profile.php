...
<?php $countryCode = get_user_country(); ?>
<div class="row">
  <div class="col-md-12">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class='form-group'>
                            ...
                            <?php if($profile_picture!='' && $profile_picture!='no file') {?>
                            <img src="<?php echo site_url().'uploads/profile/'.$profile_picture;?>" width="300px" style="margin-left:20px;" id="u_file">
                            <?php } else {?>
                            <?php if($gender=='Male') { ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="country" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_country');?>">
                              ...
                              <option value="<?php echo $scountry->country_id;?>" <?php echo ($countryCode == $scountry->country_id)?'selected':'';?>> <?php echo $scountry->country_name;?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            <select name="country" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_country');?>">
                              ...
                              <option value="<?php echo $country->country_id;?>" <?php echo ($countryCode == $country->country_id)?'selected':'';?>> <?php echo $country->country_name;?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
                          ...
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table" id="xin_hr_table">
							...
							if(!is_null($company)){
                              ...
                              if (strtotime($r->from_date) == strtotime($r->to_date)) {
                                if ($r->is_half_day == 1 || $r->is_half_day == 2) {
                                  $no_of_days = 0.5;
                                } else {
                                  $no_of_days = 1;
                                }
                              ...
                              if ($r->is_half_day == 1) {
                                $duration = $this->Xin_model->set_date_format($r->from_date) . ' ' . $this->lang->line('dashboard_to') . ' ' . $this->Xin_model->set_date_format($r->to_date) . '<br>' . $this->lang->line('xin_hrsale_total_days') . ': ' . $no_of_days . ' (' . $this->lang->line('xin_hr_leave_first_half_day') . ')';
                              } else if ($r->is_half_day == 2) {
                                $duration = $this->Xin_model->set_date_format($r->from_date) . ' ' . $this->lang->line('dashboard_to') . ' ' . $this->Xin_model->set_date_format($r->to_date) . '<br>' . $this->lang->line('xin_hrsale_total_days') . ': ' . $no_of_days  . ' (' . $this->lang->line('xin_hr_leave_second_half_day') . ')';
                              } else {
