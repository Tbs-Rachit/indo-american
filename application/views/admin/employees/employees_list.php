            ...
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-<?php echo $bncolmd; ?>">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_first_name'); ?>" name="first_name" type="text" value="" required>
                    </div>
                  </div>
                  <div class="col-md-<?php echo $bncolmd; ?>">
                    <div class="form-group">
                      <label for="last_name" class="control-label"><?php echo $this->lang->line('xin_employee_last_name'); ?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_last_name'); ?>" name="last_name" type="text" value="" required>
                    </div>
                  </div>
                  <div class="col-md-<?php echo $bncolmd; ?>">
                    <div class="form-group">
                  ...
                  <?php if ($system[0]->is_active_biometric == 'yes') { ?>
                    <div class="col-md-<?php echo $bncolmd; ?>">
                      <div class="form-group">
                        <label for="biometric_id" class="control-label"><?php echo $this->lang->line('xin_employee_biometric'); ?></label>
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_biometric'); ?>" name="biometric_id" type="text" value="">
                      </div>
                    </div>
                  <?php }  ?>
                </div>
                ...
                <div class="row">
                  ...
                  <?php } ?>
                  <div class="col-md-3 selectdiv" id="location_ajax">
                    <div class="form-group">
                      <label for="name"><?php echo $this->lang->line('left_location'); ?></label>
                      <select name="location_id" id="location_id" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_location'); ?>" required>
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-<?php echo $ncolmd; ?> selectdiv" id="department_ajax">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_username'); ?>" name="username" type="text" value="" required>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="email" class="control-label"><?php echo $this->lang->line('dashboard_email'); ?></label>
                      <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_email'); ?>" name="email" type="text" value="" required>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_password'); ?>" name="password" id="password" type="text" value="">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
