                    ...
                    <div class="tab-pane active current-tab <?php echo $get_animate; ?>" id="user_basic_info">
                      ...
                      <div class="box-body">
                        ...
                        <div class="bg-white">
                          ...
                          <div class="row">
                            <?php $bncolmd = 6;
                            if ($system[0]->is_active_biometric == 'yes') {
                              $bncolmd = 4; ?>
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label for="biometric_id" class="control-label"><?php echo $this->lang->line('xin_employee_biometric'); ?></label>
                                  <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_biometric'); ?>" name="biometric_id" type="text" value="<?php echo $biometric_id; ?>">
                                </div>
                              </div>
                            <?php } ?>
                            <div class="col-md-<?php echo $bncolmd; ?>">
                              <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input class="form-control date" readonly="readonly" placeholder="Issue Date" name="issue_date" id="issue_date" type="text">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-12 selectdiv">
                            <div class="form-group">
                              ...
                              <select name="document_type_id" id="document_type_id" class="form-control" data-id="doc" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_details_choose_dtype'); ?>">
                                <option value=""></option>
                                <?php foreach ($all_document_types as $document_type) { ?>
                                  <option value="<?php echo $document_type->document_type_id; ?>"> <?php echo $document_type->document_type; ?></option>
                                <?php } ?>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <input class="form-control date" readonly="readonly" placeholder="<?php echo $this->lang->line('xin_e_details_from'); ?>" name="from_year" id="from_year" type="text">
                                </div>
                                <div class="col-md-6">
                                  <input class="form-control date" readonly="readonly" placeholder="<?php echo $this->lang->line('dashboard_to'); ?>" name="to_year" id="to_year" type="text">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <input class="form-control date" readonly="readonly" placeholder="<?php echo $this->lang->line('xin_e_details_from'); ?>" name="from_date" id="from_date" type="text">
                                </div>
                                <div class="col-md-6">
                                  <input class="form-control date" readonly="readonly" placeholder="<?php echo $this->lang->line('dashboard_to'); ?>" name="to_date" id="to_date" type="text">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_e_details_enpassword'); ?>" name="new_password" id="new_password" type="text">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="row no-gutters row-bordered row-border-light">
                  <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                      <a class="salary-tab-list list-group-item list-group-item-action active salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="1" data-profile-block="salary" aria-expanded="true" id="suser_profile_1"><?php echo $this->lang->line('xin_employee_update_salary'); ?></a>
                      ...
                      <a class="salary-tab-list list-group-item list-group-item-action salary-tab" data-toggle="list" href="javascript:void(0);" data-profile="7" data-profile-block="overtime" aria-expanded="true" id="suser_profile_7"><?php echo $this->lang->line('dashboard_overtime'); ?></a> </div>
                  </div>
                  <div class="col-md-9">
                        ...
                        <div class="box-body pb-2">
                          ...
                          <div class="bg-white">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label for="basic_salary"><?php echo $this->lang->line('xin_grade_name'); ?></label>
                                  <!-- <input class="form-control basic_salary" placeholder="<?php echo $this->lang->line('xin_grade_name'); ?>" name="basic_salary" type="text" value="<?php echo $basic_salary; ?>"> -->
                                  <select name="grade_id" id="grade_id" class="form-control" data-plugin="select_hrm">
                                    <?php foreach ($get_company_grade as $grade) { ?>
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <label for="basic_salary"><?php echo $this->lang->line('xin_basic_salary'); ?></label>
                                  <input class="form-control basic_salary" placeholder="<?php echo $this->lang->line('xin_basic_salary'); ?>" name="basic_salary" type="text" value="<?php echo $basic_salary; ?>" oninput='this.value = this.value.replace(/[^0-9.]/g, "").replace(/(\..*)\./g, "$1");'>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              ...
                              <table class="table table-striped table-bordered dataTable" id="xin_table_all_allowances" style="width:100%;">
                                <thead>
                                  <tr>
                                    ...
                                    <th><?php echo $this->lang->line('xin_salary_allowance'); ?></th>
                                    <th><?php echo $this->lang->line('dashboard_xin_title'); ?></th>
                        ...
                        <div class="box-body pb-2">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3 selectdiv">
                              <div class="form-group">
                                <label for="account_title"><?php echo $this->lang->line('xin_salary_allowance'); ?></label>
                                <select class="form-control" name="salary_allowance" id="salary_allowance" data-plugin="select_hrm">
                                  <?php foreach ($get_all_allowance as $alw) { ?>
                                    <option value="<?= $alw->salary_benefit_id ?>"><?= $alw->salary_benefit_name ?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-2">
                              <div class="form-group">
                                <label for="allowance_amount_type"><?php echo $this->lang->line('xin_amount_type'); ?></label>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input class="form-control cont_date" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly="readonly" name="start_date" id="start_date" type="text">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                      ...
                      <div class="tab-pane <?php echo $get_animate; ?> salary-current-tab" id="statutory_deductions" style="display:none;">
                        ...
                        <div class="box-body pb-2">
                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <div class="form-group">
                                <label for="statutory_options"><?php echo $this->lang->line('xin_salary_deduction'); ?></label>
                                <select name="statutory_options" id="statutory_options" class="form-control" data-plugin="select_hrm">
                                  ...
                                  foreach ($get_all_deductions as $ded) { ?>
                                    <option value="<?= $ded->salary_benefit_id ?>"><?= $ded->salary_benefit_name ?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
