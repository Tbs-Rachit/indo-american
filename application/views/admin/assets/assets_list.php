        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php echo form_open('admin/assets/assets_list', $attributes, $hidden); ?>
              <?php
              $data = array(
                'type'        => 'hidden',
                'name'        => 'date_format',
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="category_id"><?php echo $this->lang->line('xin_acc_category'); ?></label>
                    <select class="form-control" name="category_id" id="filter_category" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_acc_category'); ?>">
                      <option value=""></option>
                ...
                <div class="col-md-1"><label for="button">&nbsp;&nbsp;</label><?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> ' . $this->lang->line('xin_get'))); ?>
                </div>
              </div>
