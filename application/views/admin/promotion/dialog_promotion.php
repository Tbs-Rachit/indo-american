  ...
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6 selectdiv">
        ...
        <div class="form-group" id="promotion_type_ajx">
          <?php $result = $this->Xin_model->get_promotion_type_on_company($company_id); ?>
          <label for="title"><?php echo $this->lang->line('xin_promotion_for'); ?></label>
          <select name="title" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_promotion_title'); ?>">
            <option value=""></option>
            <?php foreach ($result as $promotion_type) { ?>
              <option value="<?php echo $promotion_type->promotion_type_id; ?>" <?php if ($promotion_type->promotion_type_id == $title) : ?> selected="selected" <?php endif; ?>> <?php echo $promotion_type->name; ?></option>
            <?php } ?>
          </select>
        </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      jQuery("#ajx_company").change(function() {
        ...
        jQuery.get(base_url + "/get_promotion_type/" + jQuery(this).val(), function(data, status) {
          jQuery('#promotion_type_ajx').html(data);
        });
      });
      $('.d_date').datepicker({
        changeMonth: true,
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="display: table-cell;">
              ...
              <?php foreach ($promotion_type as $types) { ?>
                <?php if ($types->promotion_type_id == $title) : ?>
                  <?php echo $types->name; ?>
                <?php endif; ?>
              <?php } ?>
