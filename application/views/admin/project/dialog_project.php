            ...
            <td style="display: table-cell;">
              <ol>
                <?php foreach ($result as $employee) { ?>
                  <?php if (isset($_GET)) {
                    if (in_array($employee->user_id, $assigned_ids)) : ?>
  ...
  ?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control edate" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly name="start_date" id="start_date_modal" type="text" value="<?php echo $start_date; ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="end_date"><?php echo $this->lang->line('xin_end_date'); ?></label>
                <input class="form-control edate" placeholder="<?php echo $this->lang->line('xin_end_date'); ?>" readonly name="end_date" id="end_date_modal" type="text" value="<?php echo $end_date; ?>">
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group" id="employee_ajx">
                ...
                <select multiple name="assigned_to[]" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_project_manager'); ?>">
                  <option value=""></option>
                  <?php foreach ($result as $employee) { ?>
                    <option value="<?php echo $employee->user_id ?>" <?php if (isset($_GET)) {
                                                                        if (in_array($employee->user_id, $assigned_ids)) : ?> selected <?php endif;
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        var dates = $('#start_date_modal').val();
        jQuery('#end_date_modal').datepicker("option", "minDate", dates);
