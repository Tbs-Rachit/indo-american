 ...
 $(document).ready(function(){
		...
		$("#edit_role").validate({
			rules: {
				...
				role_access: { required: true },
			},
			// Specify validation error messages
			messages: {
				role_name: { required: "Please enter role name" },
				role_access: { required: "Please select role access" },
			},
			submitHandler: function (form) {
				edit_roleformSubmit(form);
			}
		});
		// $("#edit_role").submit(function(e){
		function edit_roleformSubmit(form){
		// e.preventDefault();
...
{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('let_staff');?>",  add_info: "", check: "<?php if(isset($_GET['role_id'])) { if(in_array('103',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", value: "103",  items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('left_reimbursement');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "444", check: "<?php if(isset($_GET['role_id'])) { if(in_array('444',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>",items: [
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "444", check: "<?php if(isset($_GET['role_id'])) { if(in_array('444',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "445", check: "<?php if(isset($_GET['role_id'])) { if(in_array('445',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "446", check: "<?php if(isset($_GET['role_id'])) { if(in_array('446',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "447", check: "<?php if(isset($_GET['role_id'])) { if(in_array('447',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	{ id: "", class: "role-checkbox-modal", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_reimbursement').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "448", check: "<?php if(isset($_GET['role_id'])) { if(in_array('448',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"}
	]}
	]},
...
{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('hd_changelog');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "87", check: "<?php if(isset($_GET['role_id'])) { if(in_array('87',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
	...
	{ id: "", class: "role-checkbox-modal", text: "<?php echo $this->lang->line('xin_is_employee');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "555", check: "<?php if(isset($_GET['role_id'])) { if(in_array('555',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
]
});
