...
<?php endif;?>  
  ...
  <div class="content-wrapper">
    ...
    .breadcrumb .date-time > div {
      ...
      <ol class="breadcrumb">
	      <li><div class="date-time"><div class="show-date"><i class="fa fa-calendar" aria-hidden="true"></i> <span id="myTime">Tue Mar 28 2017</span>
				      <div class="show-time"><i class="fa fa-clock-o" aria-hidden="true"></i> <span id="myTimeData"></span></div></div></li>
...
<script>
	function timerTop() {
		setInterval(function () {
			...
			if (document.getElementById('myTimeData')) {
