  ...
  ?>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control e_date" placeholder="<?php echo $this->lang->line('xin_start_date'); ?>" readonly="true" name="start_date" id="e_start_date" type="text" value="<?php echo $start_date; ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="end_date"><?php echo $this->lang->line('xin_end_date'); ?></label>
                <input class="form-control e_date" placeholder="<?php echo $this->lang->line('xin_end_date'); ?>" readonly="true" name="end_date" id="e_end_date" type="text" value="<?php echo $finish_date; ?>">
              </div>
            </div>
          </div>
        </div>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        var date = $('#e_start_date').val();
        $("#e_end_date").datepicker("option", "minDate", date)

        jQuery('#e_start_date').on('change', function() {
          var date = $(this).val();
          $("#e_end_date").datepicker("option", "minDate", date)
        });
        ...
        $("#edit_training").validate({
          ...
          messages: {
            ...
            training_cost: {
              required: "Please enter training cost"
            },
            'employee_id[]': {
          ...
          submitHandler: function(form) {
            edit_trainingformSubmit(form);
          }
        });

        // $("#edit_training").submit(function(e){
        function edit_trainingformSubmit(form) {
