<?php
	...
	// get company > grade
	public function ajax_company_grade_info($id) {
	...
	// check username
	public function check_comapny_username($id)
	{
	...
	// check username Edit
	public function check_comapny_username_edit($id ,$uname)
	{
		$sql = 'SELECT * FROM xin_companies WHERE company_id = ? and username = ?';
		$binds = array($id,$uname);
		$query = $this->db->query($sql, $binds);
		return $query->num_rows();
	}
}
