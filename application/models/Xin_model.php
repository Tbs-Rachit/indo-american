...
class Xin_model extends CI_Model
{
	...
	public function select_module_class($mClass, $mMethod)
	{
		...
		if ($mClass == 'dashboard') {
			...
			$arr['emp_open'] = 'active';
			return $arr;
		} else if ($mClass == 'reimbursement') {
			$arr['reim_active'] = 'active';
			$arr['emp_open'] = 'active';
			return $arr;
	...
	// get single grade
	public function read_grade_info($id)
	{
	...
	// get single grade benefti
	public function read_benefit_info($id)
	{
	...
	// get companies id on Company code
	public function get_companies_on_code($name)
	{
		$sql = 'SELECT * from xin_companies WHERE username = ?';
		$binds = array($name);
		$query = $this->db->query($sql, $binds);
		if ($query->num_rows() > 0) {
			return $query->result();
	...
	public function get_company_grade($id)
	{
		$sql = 'SELECT * FROM xin_grade WHERE company_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	// get all table rows 
	public function get_salary_benefit()
	{
		return  $query = $this->db->query("SELECT * from xin_salary_benefits");
	}
	// get all table rows 
	public function get_grade()
	{
		return  $query = $this->db->query("SELECT * from xin_grade");
	}
	// get all table rows 
	public function get_grade_benefit()
	{
		return  $query = $this->db->query("SELECT * from xin_grade_benefit");
	}
	// get all table rows 
	public function get_grade_benefit_all_ById($id)
	{
	...
	// get all table rows 
	public function get_grade_benefit_ded_ById($id)
	{
	...
	//get all promotion_type
	public function get_promotion_types()
	{
		return  $query = $this->db->query("SELECT * from xin_promotion_type");
	}
	...
	// Function to add record in table
	public function add_salary_benefit($data)
	{
		$this->db->insert('xin_salary_benefits', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	// Function to add record in table
	public function add_grade_setting($data)
	{
	...
	// Function to add record in table
	public function add_grade_benefit_setting($data)
	{
		$this->db->insert('xin_grade_benefit', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	public function check_grade_benefits($grade, $benefit, $company_id)
	{
		$sql = 'SELECT * FROM xin_grade_benefit WHERE grade_id = ? and benefit_id = ? and company_id = ?';
		$binds = array($grade, $benefit, $company_id);
		$query = $this->db->query($sql, $binds);
		return $query->num_rows();
	}

	public function add_promotion_type($data)
	{
		$this->db->insert('xin_promotion_type', $data);
		if ($this->db->affected_rows() > 0) {
			return true;
		} else {
			return false;
	...
	// Function to Delete selected record from table
	public function delete_salary_benefit_record($id)
	{
		$this->db->where('salary_benefit_id', $id);
		$this->db->delete('xin_salary_benefits');
	}
	// Function to Delete selected record from table
	public function delete_grade_setting_record($id)
	{
		$this->db->where('grade_id', $id);
		$this->db->delete('xin_grade');
	}
	// Function to Delete selected record from table
	public function delete_grade_benefit_setting_record($id)
	{
		$this->db->where('grade_benefit_id', $id);
		$this->db->delete('xin_grade_benefit');
	}
	// Function to Delete selected record from table
	public function delete_promotion_type_record($id)
	{
		$this->db->where('promotion_type_id', $id);
		$this->db->delete('xin_promotion_type');
	}
	// Function to Delete selected record from table
	...
	// get single record > db table > constant
	public function read_salary_benefit($id)
	{
	...
	// get single record > db table > constant
	public function read_grade_setting($id)
	{
	...
	// get single record > db table > constant
	public function read_grade_benefit_setting($id)
	{
	...
	// get single record > db table > constant
	public function read_promotion_type($id)
	{

		$sql = 'SELECT * FROM xin_promotion_type where promotion_type_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_company_grade_benefit_setting($id)
	{

		$sql = 'SELECT * FROM xin_grade_benefit where company_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	{
		$query = $this->db->query("SELECT * from xin_promotion_type");
		return $query->result();
	}

	// get promotion type > Company > constant
	public function get_promotion_type_on_company($id)
	{

		$sql = 'SELECT * FROM xin_promotion_type where company_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function get_promotion_type_id($id)
	{
		$sql = 'SELECT * FROM xin_promotion_type where promotion_type_id = ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	// Function to update record in table
	public function update_salary_benefit_record($data, $id)
	{
		$this->db->where('salary_benefit_id', $id);
		if ($this->db->update('xin_salary_benefits', $data)) {
			return true;
		} else {
			return false;
		}
	...
	// Function to update record in table
	public function update_promotion_type_record($data, $id)
	{
		$this->db->where('promotion_type_id', $id);
		if ($this->db->update('xin_promotion_type', $data)) {
			return true;
		} else {
			return false;
		}
	...
	// Function to update record in table
	public function update_grade_setting_record($data, $id)
	{
		$this->db->where('grade_id', $id);
	...
	public function update_grade_benefit_setting_record($data, $id)
	{
		$this->db->where('grade_benefit_id', $id);
		if ($this->db->update('xin_grade_benefit', $data)) {
			return true;
		} else {
			return false;
		}
...
ORDER BY `next_birthday`");
	...
	public function get_employees_on_department($to_id)
	{
...
ORDER BY `expiry_date`");
	...
	// Function to Get Deduction record from table 

	public function get_deduction_list()
	{
		$sql = 'SELECT * FROM xin_salary_benefits where salary_benefit_type = ?';
		$binds = array(2);
		$query = $this->db->query($sql, $binds);
	...
	public function ajax_benefit_info($c_id, $b_id)
	{
		$condition = "company_id =" . "'" . $c_id . "'";
		$condition2 = "salary_benefit_type =" . "'" . $b_id . "'";
		$this->db->select('*');
		$this->db->from('xin_salary_benefits');
