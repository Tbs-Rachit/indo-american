...
class Custom_fields_model extends CI_Model {
	...
	public function get_is_display_hrsale_module_attributes($is_display) {
		$query = $this->db->query("SELECT * from xin_hrsale_module_attributes where `module_id` = '1' and `is_display` = $is_display order by priority asc");
		  return $query->result();
	  }
